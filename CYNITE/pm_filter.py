...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ', url="https://t.me/pathan_h")
                  ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ', url="https://t.me/pathan_h")
        ],[
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/pathan_h')
                     ], [
                      InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/pathan_h'),
                      InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/pathan_h')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
